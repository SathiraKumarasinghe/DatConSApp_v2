...
#def app_section_button(option1):
    ...
    #with col1:
        #st.markdown(option1, unsafe_allow_html=True) 
    ...
    # Set website details
st.set_page_config(page_title ="DatCon App", 
                       #page_icon=icon, 
                       layout='centered')
...
def display_app_header(main_txt,sub_txt,is_sidebar = False):
    ...
    html_temp = f"""
    <h2 style = "color:#FFFFFF; text_align:center; font-weight: bold;"> {main_txt} </h2>
...
def sub_text(text):
    ...
    html_temp = f"""
    <p style = "color:#FFFFFF; text_align:justify;"> {text} </p>
    </div>
    """
